...
#define RTPRIV_IOCTL_GSTAINFO			(SIOCIWFIRSTPRIV + 0x1A)	// ASUS EXT
#define RTPRIV_IOCTL_GSTAT			(SIOCIWFIRSTPRIV + 0x1B)	// ASUS EXT
#define RTPRIV_IOCTL_GRSSI			(SIOCIWFIRSTPRIV + 0x1C)	// ASUS EXT
