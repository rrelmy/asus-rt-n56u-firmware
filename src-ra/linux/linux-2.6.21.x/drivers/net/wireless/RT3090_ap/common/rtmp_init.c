...
EXPORT_SYMBOL(RTMPIoctlGetSTAINFO);	// ASUS EXT
EXPORT_SYMBOL(RTMPIoctlGetSTAT);	// ASUS EXT
EXPORT_SYMBOL(RTMPIoctlGetRSSI);	// ASUS EXT
EXPORT_SYMBOL(RTMPIoctlGetRadioStatus);
