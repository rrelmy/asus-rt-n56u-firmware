...
function show_invitation(share_link_url){
	...
	$('invite_share').innerHTML = "http://www.asusnetwork.net/" + share_link_url;
...
function show_view_info(obj_id){
	...
	//hash_url = router_synclist_desc[j] + ">" + "http://www.asusnetwork.net/" + router_synclist_sharelink[j] + "/" + sharelink_folder + ">" + router_synclist_rule[j] + ">" + router_synclist_captcha[j];
	...
	$('invite_rule').innerHTML = "Sync rule: "+sync_rule_desc;
	$('invite_share').innerHTML = "http://www.asusnetwork.net/"+share_link_hashed;	
