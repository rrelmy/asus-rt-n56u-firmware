...
function genErrorHint(){
	if(document.getElementsByTagName("body")[0]){
		...
		htmlCode += "<br><br><br><p style='font-size:20px;line-height: 25px;color:#FC0;' class='QISGeneralFont'>The LAN IP of " + parent.productid + " may have been changed.<br>Duo to IE caching issue, please close this browser and access www.asusnetwork.net again.</p>";
		document.getElementsByTagName("body")[0].innerHTML = htmlCode;
	}
	else{
		alert("The LAN IP of " + parent.productid + " may have been changed. Duo to IE caching issue, please close this browser and access www.asusnetwork.net again.");
	}
} 
