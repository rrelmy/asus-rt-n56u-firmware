...
enum{
	...
	RESTART_WIFI = 0x80000,
	RESTART_ITUNES = 0x100000,
	RESTART_VPN = 0x200000,
	RESTART_SWITCH = 0x400000
};
...
#define ITVL_RESTART_ITUNES 3
#define ITVL_RESTART_VPN 1
#define ITVL_RESTART_SWITCH 1
// 2008.10 magic }
