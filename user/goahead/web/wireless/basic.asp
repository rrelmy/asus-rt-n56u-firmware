...
function initValue()
{
	...
	initTranslation();
	if (i++ < BssidNum)
		document.wireless_basic.mssid_0.value = '<% getCfgGeneral(1, "SSID1"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_1.value = '<% getCfgGeneral(1, "SSID2"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_2.value = '<% getCfgGeneral(1, "SSID3"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_3.value = '<% getCfgGeneral(1, "SSID4"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_4.value = '<% getCfgGeneral(1, "SSID5"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_5.value = '<% getCfgGeneral(1, "SSID6"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_6.value = '<% getCfgGeneral(1, "SSID7"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_7.value = '<% getCfgGeneral(1, "SSID8"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_8.value = '<% getCfgGeneral(1, "SSID9"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_9.value = '<% getCfgGeneral(1, "SSID10"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_10.value = '<% getCfgGeneral(1, "SSID11"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_11.value = '<% getCfgGeneral(1, "SSID12"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_12.value = '<% getCfgGeneral(1, "SSID13"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_13.value = '<% getCfgGeneral(1, "SSID14"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_14.value = '<% getCfgGeneral(1, "SSID15"); %>';
	if (i++ < BssidNum)
		document.wireless_basic.mssid_15.value = '<% getCfgGeneral(1, "SSID16"); %>';
...
<table width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
  ...
  <tr id="div_hssid7"> 
    ...
    <td><input type=text name=mssid_7 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid8"> 
    ...
    <td><input type=text name=mssid_8 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid9"> 
    ...
    <td><input type=text name=mssid_9 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid10"> 
    ...
    <td><input type=text name=mssid_10 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid11"> 
    ...
    <td><input type=text name=mssid_11 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid12"> 
    ...
    <td><input type=text name=mssid_12 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid13"> 
    ...
    <td><input type=text name=mssid_13 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid14"> 
    ...
    <td><input type=text name=mssid_14 size=20 maxlength=32 value="">
  ...
  <tr id="div_hssid15"> 
    ...
    <td><input type=text name=mssid_15 size=20 maxlength=32 value="">
