...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cross-prefix=mipsel-linux- --enable-cross-compile --arch=mips --target-os=linux --prefix=/root/RT-N56U/source/user/ffmpeg-0.6.1/source/../install --enable-pthreads --disable-debug --disable-avdevice --disable-swscale --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-swscale-alpha --disable-encoders --disable-decoders --disable-bsfs --disable-indevs --disable-outdevs --disable-devices --disable-filters --disable-muxers --disable-parsers --disable-protocols --enable-protocol=file --disable-aandct --disable-dct --disable-fft --disable-golomb --disable-lpc --disable-mdct --disable-rdft --disable-vaapi --disable-vdpau --disable-dxva2
prefix=/root/RT-N56U/source/user/ffmpeg-0.6.1/source/../install
...
SRC_PATH="/root/RT-N56U/source/user/ffmpeg-0.6.1/source"
SRC_PATH_BARE=/root/RT-N56U/source/user/ffmpeg-0.6.1/source
BUILD_ROOT="/root/RT-N56U/source/user/ffmpeg-0.6.1/source"
ARCH=mips
CC=mipsel-linux-gcc
AS=mipsel-linux-gcc
LD=mipsel-linux-gcc
...
CFLAGS=-O2 -fomit-frame-pointer -pipe  -Dlinux -D__linux__ -Dunix -DEMBED -I/root/RT-N56U/source/lib/include -I/root/RT-N56U/source/uClibc++/include -I/root/RT-N56U/source    -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno
ASFLAGS=   -fPIC
CC_O=-o $@
LDFLAGS= -Wl,--fatal-warnings -L/root/RT-N56U/source/lib/lib -L/root/RT-N56U/source/uClibc++/src -Wl,--fatal-warnings -L/root/RT-N56U/source/lib/lib -L/root/RT-N56U/source/uClibc++/src -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
