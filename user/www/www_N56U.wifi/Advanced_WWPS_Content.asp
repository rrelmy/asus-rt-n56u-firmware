	...
	<tr>
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
			<tr>
			  <th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(13,1);">WPS</a></th>
			  <td>
			...
			<tr id="devicePIN_tr">
			  <th>
			  	<span id="devicePIN_name"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,4);">AP PIN</a></span>			  
			  </th>
			  <td>
			...
			<tr id="pin_tr">
				<th>
			  	<span id="wpsPIN_name"><a class="hintstyle" href="javascript:void(0);" onclick="openHint(13,3);">Client PIN</a></span>
			  </th>
			  <td>
