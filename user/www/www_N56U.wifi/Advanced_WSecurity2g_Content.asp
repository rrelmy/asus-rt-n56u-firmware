	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
			...
			<tr>
			  ...
			  <td>
			    <input type="text" maxlength="5" class="input" size="5" name="rt_radius_port" value="<% nvram_get_x("WLANAuthentication11a","rt_radius_port"); %>" onkeypress="return is_number(this)" /></td>
			  </tr>
			<tr>
				<th >
