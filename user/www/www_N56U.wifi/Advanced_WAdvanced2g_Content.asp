	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" id="WAdvTable">
			...
			<tr>
			  ...
			  <td>
				<input type="radio" value="1" name="rt_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'rt_ap_isolate', '1')" <% nvram_match_x("WLANConfig11b","rt_ap_isolate", "1", "checked"); %>>Yes
				<input type="radio" value="0" name="rt_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'rt_ap_isolate', '0')" <% nvram_match_x("WLANConfig11b","rt_ap_isolate", "0", "checked"); %>>No
			  </td>
			</tr>
			...
			<tr>
			  ...
			  <td>
				<select name="rt_wme_no_ack"class="input" onChange="return change_common(this, 'WLANConfig11b', 'rt_wme_no_ack')">
