...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<span class="top-messagebold">SSID: </span><input type="button" class="button2" style="width:70px;" value="2.4GHz" id="elliptic_ssid_2g" onclick="go_setting(2);" readonly=readonly><input type="button" style="width:70px;" class="button5" value="5GHz" id="elliptic_ssid" onclick="go_setting(5);" readonly=readonly><br/>\n';
...
tablink[0] = new Array("", "Advanced_Wireless2g_Content.asp", "Advanced_WWPS_Content.asp", "Advanced_WMode2g_Content.asp", "Advanced_ACL2g_Content.asp", "Advanced_WSecurity2g_Content.asp", "Advanced_WAdvanced2g_Content.asp");
...
menuL1_link = new Array("", "index.asp", "aidisk.asp", "upnp.asp", "EZQoS.asp", "as.asp");
