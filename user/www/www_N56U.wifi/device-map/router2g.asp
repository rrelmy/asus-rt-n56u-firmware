...
function rt_auth_mode_change(isload){
	...
	if(mode == "wpa" || mode == "wpa2" || mode == "psk")
		blocking("rt_crypto", 1);
	else
		blocking("rt_crypto", 0);
	
	/* enable/disable psk passphrase */
	if(mode == "psk")
		blocking("rt_wpa_psk", 1);
	else
		blocking("rt_wpa_psk", 0);
...
function change_wlweptype(wep_type_obj){
	var mode = document.form.rt_auth_mode.value; //2009.03 magic
...
function show_wepkey_help(){
	if(document.form.rt_wep_x.value == 1)
		parent.showHelpofDrSurf(0, 12);
	else if(document.form.rt_wep_x.value == 2)
...
function startPBCmethod(){
	...
	document.WPSForm.current_page.value = "/index.asp?flag=Router2g";
...
<input type="hidden" name="wl_ssid" value="<% nvram_char_to_ascii("WLANConfig11b", "wl_ssid"); %>">
<input type="hidden" name="wl_wpa_mode" value="<% nvram_get_x("WLANConfig11b", "wl_wpa_mode"); %>">
<input type="hidden" name="wl_key1" value="<% nvram_char_to_ascii("WLANConfig11b", "wl_key1"); %>">
<input type="hidden" name="wl_key2" value="<% nvram_char_to_ascii("WLANConfig11b", "wl_key2"); %>">
<input type="hidden" name="wl_key3" value="<% nvram_char_to_ascii("WLANConfig11b", "wl_key3"); %>">
<input type="hidden" name="wl_key4" value="<% nvram_char_to_ascii("WLANConfig11b", "wl_key4"); %>">
...
<table width="290" border="0" align="center" cellpadding="0" cellspacing="0">
	<td align="center" class="r1">2.4G</td>
	<td align="center" class="r2"><a href="router.asp">5G</a></td>
	<td>&nbsp</td>
</table>
</div>
...
<div id='rt_crypto' style='display:none;'>
<table width="290" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
...
<div id='rt_wpa_psk' style='display:none'>
<table width="290" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
