        ...
        if (document.form.wl_nband.value == "2"){
			...
			if (country == "AS" || 
			 ...
			 country == "SY" || 
                	 ...
                	 country == "YE" || 
                	 country == "ZW")
                		channels = new Array(0, 36, 40, 44, 48, 52, 56, 60, 64, 149, 153, 157, 161, 165);
                		...
                		country == "HU" ||
            		    	...
            		    	country == "GB" || 
            		    	country == "UZ")
                		channels = new Array(0, 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140);
            		    	...
            		    	country == "TN" ||
            		    	country == "TR")
                		channels = new Array(0, 36, 40, 44, 48, 52, 56, 60, 64);
                	
                	else if(country == "AR" || country == "TW")
                		channels = new Array(0, 52, 56, 60, 64, 149, 153, 157, 161);
                	...
                	*/
                		...
                		channels = new Array(0, 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 132, 136, 140, 149, 153, 157, 161, 165);
                }                
        }
