...
<input type="hidden" name="rt_ssid" value="<% nvram_char_to_ascii("WLANConfig11b", "rt_ssid"); %>">
<input type="hidden" name="rt_wpa_mode" value="<% nvram_get_x("WLANConfig11b", "rt_wpa_mode"); %>">
<input type="hidden" name="rt_key1" value="<% nvram_char_to_ascii("WLANConfig11b", "rt_key1"); %>">
<input type="hidden" name="rt_key2" value="<% nvram_char_to_ascii("WLANConfig11b", "rt_key2"); %>">
<input type="hidden" name="rt_key3" value="<% nvram_char_to_ascii("WLANConfig11b", "rt_key3"); %>">
<input type="hidden" name="rt_key4" value="<% nvram_char_to_ascii("WLANConfig11b", "rt_key4"); %>">
...
<table width="290" border="0" align="center" cellpadding="0" cellspacing="0">
	<td align="center" class="r2"><a href="router2g.asp">2.4G</a></td>
	<td align="center" class="r1">5G</td>
	<td>&nbsp</td>
</table>
