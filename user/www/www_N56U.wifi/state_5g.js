...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<span class="top-messagebold">SSID: </span><input type="button" class="button2" style="width:60px;" value="2.4GHz" id="elliptic_ssid_2g" onclick="go_setting(2);" readonly=readonly><input type="button" class="button5" style="width:60px;" value="5GHz" id="elliptic_ssid" onclick="go_setting(5);" readonly=readonly><br/>\n';
