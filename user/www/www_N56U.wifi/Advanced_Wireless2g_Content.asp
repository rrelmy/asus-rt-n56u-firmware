...
function validForm(){
	...
	if(auth_mode == "psk"){ //2008.08.04 lock modified
		...
		if(!validate_range(document.form.rt_wpa_gtk_rekey, 0, 86400))
			return false;
	}
		  ...
		  <td bgcolor="#FFFFFF">
			<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="WLgeneral">
			  ...
			  <tr>
				...
				<td>
					<select name="rt_gmode" class="input" onChange="return change_common(this, 'WLANConfig11b', 'rt_gmode')">
						<option value="2" <% nvram_match_x("WLANConfig11b","rt_gmode", "2","selected"); %>>Auto</option>
				  ...
				  <input type="checkbox" style="margin-left:30" name="rt_gmode_check" value="" onClick="return change_common(this, 'WLANConfig11b', 'rt_gmode_check', '1')"> b/g Protection</input>
			  ...
			  <tr>
				...
				<td><input type="text" maxlength="3" size="3" name="rt_TxPower" class="input"  value="<% nvram_get_x("WLANConfig11b", "rt_TxPower"); %>"></td>
			  </tr>
