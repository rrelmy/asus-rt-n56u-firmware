...
function update_wanip(e) {
  $.ajax({
    ...
    success: function(response) {
			var old_wan_ip = $("#WANIP")[0].innerHTML;
...
<table width="95%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="table1px">
  <tr>
    <th width="40%"><#ConnectionStatus#>:</th>
    <td width="60%>
    ...
    <input type="button" id="connectbutton_nolink" style="margin:-40 0 0 70;" class="button" value="<#Disconnect#>" onclick="submitWANAction(1);">
	</td>
  </tr>
  <tr>
    <th><#WAN_IP#>:</th>
