...
function modem_html(device_seat, modem_order){
	...
	icon_html_code += '    <div id="iconModem_'+modem_order+'" class="iconModem" onclick="setSelectedModemOrder(this.id);clickEvent(this);"></div>\n';
	icon_html_code += '</a>\n';
...
function WIMAX_html(device_seat, WIMAX_order){
	...
	icon_html_code += '    <div id="iconWIMAX_'+WIMAX_order+'" class="icon4G" onclick="clickEvent(this);"></div>\n';
	icon_html_code += '</a>\n';
