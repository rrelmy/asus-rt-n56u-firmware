...
<script type="text/javascript" src="/hsdpa_list.js"></script>
		...
		<tr>
			...
			<td>
				<select name="modem_enable" class="input" onClick="openHint(21,1);" onchange="switch_modem_mode(this.value);gen_list(this.value);show_ISP_list();show_APN_list();">
					...
					<option value="1" <% nvram_match_x("General", "modem_enable", "1", "selected"); %>>Enable 3G</option>
					<!--option value="2" <% nvram_match_x("General", "modem_enable", "2", "selected"); %>>Enable WiMAX</option-->
				</select>
				<span id="EVDO_block" style="display:none;"><input type="checkbox" id="EVDO_check" <% nvram_match_x("General", "EVDO_on", "1", "checked"); %>> EVDO</span>
