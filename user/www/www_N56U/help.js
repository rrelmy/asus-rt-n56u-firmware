...
helptitle[3] = [["", ""],
				...
				["<#WLANConfig11b_x_IGMPSnooping_itemname#>", "wl_igmpsnenable"],
...
helptitle[7] = [["", ""],
				...
				["Hardware NAT", "hwnat"],
				["<#NAT_passthrough_itemname#>", "fw_pt_pptp"],
				["<#NAT_passthrough_itemname#>", "fw_pt_l2tp"],
				["<#NAT_passthrough_itemname#>", "fw_pt_ipsec"],
...
helpcontent[3] = new Array("",
						   ...
						   "<#WLANConfig11b_x_IGMPSnooping_itemdesc#>",
