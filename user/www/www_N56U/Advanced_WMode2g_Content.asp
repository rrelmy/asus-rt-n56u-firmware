	  ...
	  <td bgcolor="#FFFFFF">
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
			<tr>
				...
				<td>
					<input type="radio" value="1" name="rt_wdsapply_x" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'rt_wdsapply_x', '1')" <% nvram_match_x("WLANConfig11b","rt_wdsapply_x", "1", "checked"); %>><#checkbox_Yes#>
					<input type="radio" value="0" name="rt_wdsapply_x" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'rt_wdsapply_x', '0')" <% nvram_match_x("WLANConfig11b","rt_wdsapply_x", "0", "checked"); %>><#checkbox_No#>
				</td>
			</tr>		
			<tr>
				<th align="right" >
