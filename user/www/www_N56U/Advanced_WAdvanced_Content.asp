...
function applyRule(){
	...
	if(validForm()){
		/*if(document.form.hwnat.value == 1 && document.form.wl_mrate.value != "0" && sw_mode == "1"){
			...
			<tr id="wl_rate">
			  ...
			  <td>
				<select name="wl_rate" class="input" onChange="return change_common(this, 'WLANConfig11b', 'wl_rate')">
				  ...
				  <!--option value="1000000" <% nvram_match_x("WLANConfig11b","wl_rate", "1000000","selected"); %>>1</option>
				  <option value="2000000" <% nvram_match_x("WLANConfig11b","wl_rate", "2000000","selected"); %>>2</option>
				  <option value="5500000" <% nvram_match_x("WLANConfig11b","wl_rate", "5500000","selected"); %>>5.5</option>
				  <option value="6000000" <% nvram_match_x("WLANConfig11b","wl_rate", "6000000","selected"); %>>6</option>
				  <option value="9000000" <% nvram_match_x("WLANConfig11b","wl_rate", "9000000","selected"); %>>9</option>
				  <option value="11000000" <% nvram_match_x("WLANConfig11b","wl_rate", "11000000","selected"); %>>11</option>
				  <option value="12000000" <% nvram_match_x("WLANConfig11b","wl_rate", "12000000","selected"); %>>12</option>
				  <option value="18000000" <% nvram_match_x("WLANConfig11b","wl_rate", "18000000","selected"); %>>18</option>
				  <option value="24000000" <% nvram_match_x("WLANConfig11b","wl_rate", "24000000","selected"); %>>24</option>
				  <option value="36000000" <% nvram_match_x("WLANConfig11b","wl_rate", "36000000","selected"); %>>36</option>
				  <option value="48000000" <% nvram_match_x("WLANConfig11b","wl_rate", "48000000","selected"); %>>48</option>
				  <option value="54000000" <% nvram_match_x("WLANConfig11b","wl_rate", "54000000","selected"); %>>54</option-->
				</select>
			  </td>
			</tr>
			...
			<tr>
				...
				<td>
					<select name="wl_mrate" class="input" onClick="openHint(3, 7);" onChange="return change_common(this, 'WLANConfig11b', 'wl_mrate')">
						...
						<option value="3" <% nvram_match_x("WLANConfig11b", "wl_mrate", "3", "selected"); %>>5.5</option>
						<option value="4" <% nvram_match_x("WLANConfig11b", "wl_mrate", "4", "selected"); %>>6</option>
						<option value="5" <% nvram_match_x("WLANConfig11b", "wl_mrate", "5", "selected"); %>>9</option>
						<option value="6" <% nvram_match_x("WLANConfig11b", "wl_mrate", "6", "selected"); %>>11</option>
						<option value="7" <% nvram_match_x("WLANConfig11b", "wl_mrate", "7", "selected"); %>>12</option>
						<option value="8" <% nvram_match_x("WLANConfig11b", "wl_mrate", "8", "selected"); %>>18</option>
						<option value="9" <% nvram_match_x("WLANConfig11b", "wl_mrate", "9", "selected"); %>>24</option>
						<option value="10" <% nvram_match_x("WLANConfig11b", "wl_mrate", "10", "selected"); %>>36</option>
						<option value="11" <% nvram_match_x("WLANConfig11b", "wl_mrate", "11", "selected"); %>>48</option>
						<option value="12" <% nvram_match_x("WLANConfig11b", "wl_mrate", "12", "selected"); %>>54</option-->
