...
function validate_string_ssid(o){
	...
	//alert(document.form.rt_ssid.value);
	if(document.form.rt_ssid.value == "")
		o.value = "ASUS_2G"; // 2009.02.19 Lock modified for RT-N13U Rev.B1
	else if(document.form.current_page.value == "Advanced_WirelessGuest_Content.asp" && document.form.rt_guest_ssid_1.value == "")
		o.value = "guest";
	else if(document.form.current_page.value == "Basic_GOperation_Content.asp" && document.form.rt_ssid.value == "")
		o.value = "default";
	else if(document.form.current_page.value == "Basic_AOperation_Content.asp" && document.form.rt_ssid.value == "")
		o.value = "default";
...
rt_auth_mode_change_guest(1);
	...
	else if(document.form.current_page.value == "Advanced_WMode2g_Content.asp"){
		if (isCard() == 'ralink'){
			document.form.rt_mode_x.options[1].value = null;
			document.form.rt_mode_x.options[1] = null;
			change_wireless_bridge2(document.form.rt_mode_x.value, rcheck(document.form.rt_wdsapply_x), 1, 0);
		}
		else if(isModel2() == 'WL530'){
			change_wireless_bridge2(document.form.rt_mode_x.value, rcheck(document.form.rt_wdsapply_x), 1, 0);
		}
		else{
			change_wireless_bridge(document.form.rt_mode_x.value, rcheck(document.form.rt_wdsapply_x), 0, 0);
		}
	}
...
{if (a=="0" && r == "0" && mflag != 1)
{//document.form.rt_mode_x.value = "0";
//m = "0";
}
if (m == "0") 
...
inputCtrl(document.form.rt_guest_phrase_x_1, 1);
inputCtrl(document.form.rt_guest_wep_x_1, 1);
inputCtrl(document.form.rt_guest_key1_1, 1);
inputCtrl(document.form.rt_guest_key2_1, 1);
inputCtrl(document.form.rt_guest_key3_1, 1);
inputCtrl(document.form.rt_guest_key4_1, 1);
inputCtrl(document.form.rt_guest_key_1, 1);
unmasq_wepkey_guest();
}
...
function automode_hint(){ //Lock add 2009.11.05 for 54Mbps limitation in auto mode + WEP/TKIP.
	if(document.form.rt_gmode.value == "2" && 
	   (document.form.rt_wep_x.value == 1 || 
	    document.form.rt_wep_x.value == 2 || 
...
function change_common(o, s, v){
	change = 1;
	pageChanged = 1;
	if(v == "rt_auth_mode"){ /* Handle AuthenticationMethod Change */
		rt_auth_mode_change(0);
		if(o.value == "psk" || o.value == "wpa"){
			...
			//document.form.rt_phrase_x.focus();
	...
	else if(v == "rt_wep_x"){ /* Handle AuthenticationMethod Change */
		change_wlweptype(o, "WLANConfig11b");
		nmode_limitation();
		automode_hint();
	}
	else if(v == "rt_key"){ /* Handle AuthenticationMethod Change */
		...
		change_wireless_bridge(o.value, rcheck(document.form.rt_wdsapply_x), 0, 1);
	}
	else if (v == "rt_guest_auth_mode_1") /* Handle AuthenticationMethod Change */
...
document.form.rt_guest_phrase_x_1.select();
	...
	else if (v == "rt_guest_wep_x_1") /* Handle AuthenticationMethod Change */
	{
...
{change_wireless_bridge2(document.form.rt_mode_x.value,
rcheck(document.form.rt_wdsapply_x),
1, 0);
}
else{}
}
...
function rt_wep_change(){
	...
	if(mode == "psk" || mode == "wpa" || mode == "wpa2"){
		...
		inputCtrl(document.form.rt_wpa_psk, 0);
		inputCtrl(document.form.rt_wpa_gtk_rekey, 0);
		inputCtrl(document.form.rt_wep_x, 0); //2009.0310 Lock 
		inputCtrl(document.form.rt_phrase_x, 0);
		inputCtrl(document.form.rt_key1, 0);
		inputCtrl(document.form.rt_key2, 0);
		inputCtrl(document.form.rt_key3, 0);
...
function rt_auth_mode_reconf(){
	if(document.form.rt_auth_mode.value == "radius" || document.form.rt_auth_mode.value == "wpa" || document.form.rt_auth_mode.value == "wpa2")
		document.form.rt_auth_mode.value = "open";
	
	for(var i = 5; i <= 8; ++i){
		document.form.rt_auth_mode.options[i].value = null;
		document.form.rt_auth_mode.options[i] = null;
	}
}
...
if ((wmode == "2"||wmode == "3") && document.form.rt_HT_BW.value != "0")
...
{wep1 = document.form.rt_key1.value;
wep2 = document.form.rt_key2.value;
wep3 = document.form.rt_key3.value;
wep4 = document.form.rt_key4.value;
if (wep1.length == 10)
{wep = "**********";
}
...
{if (document.form.rt_key1.value.indexOf("**********") != -1)
document.form.rt_key1.value = wep1;
if (document.form.rt_key2.value.indexOf("**********") != -1)
document.form.rt_key2.value = wep2;
if (document.form.rt_key3.value.indexOf("**********") != -1)
document.form.rt_key3.value = wep3;
if (document.form.rt_key4.value.indexOf("**********") != -1)
document.form.rt_key4.value = wep4;
}
