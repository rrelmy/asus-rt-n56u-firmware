					...
					<table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle">
						...
						<tr>
							<td align="center" bgcolor="#FFFFFF">
								<textarea cols="63" rows="14" wrap="off" readonly="readonly" id="textarea" style="width:98%; font-family:'Courier New', Courier, mono; font-size:11px;" ><% nvram_dump("syslog.log","syslog.sh"); %></textarea>
							</td>
						</tr>
						</tbody>
					</table>
