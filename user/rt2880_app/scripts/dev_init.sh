...
#fi
	...
	echo "lp[0-9] 0:0 0660 */sbin/asus_lp \$MDEV \$ACTION" >> /etc/mdev.conf
	echo "sd[a-z][1-9] 0:0 0660 */sbin/asus_sd \$MDEV \$ACTION" >> /etc/mdev.conf
	echo "sd[a-z] 0:0 0660 */sbin/asus_sd \$MDEV \$ACTION" >> /etc/mdev.conf
	echo "sg[0-9] 0:0 0660 @/sbin/asus_sg \$MDEV \$ACTION" >> /etc/mdev.conf
	...
	echo "[1-2]-[1-2]:[1-9].[0-9] 0:0 0660 */sbin/asus_usb_interface \$MDEV \$ACTION" >> /etc/mdev.conf
